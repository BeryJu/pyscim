...
from pyscim import rest
from pyscim.configuration import Configuration
from pyscim.exceptions import ApiTypeError, ApiValueError, ApiException
from pyscim.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.bulk_post  # this is an instance of the class Endpoint
        api_instance.bulk_post()  # this invokes api_instance.bulk_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.bulk_post.callable or self.callable in this class
