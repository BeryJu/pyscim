...
class PatchOperation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, op, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            path (str): Required when op is remove, optional otherwise. [optional]  # noqa: E501
            value (bool, date, datetime, dict, float, int, list, str, none_type): Can be any value - string, number, boolean, array or object. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, op, *args, **kwargs):  # noqa: E501
        """PatchOperation - a model defined in OpenAPI
